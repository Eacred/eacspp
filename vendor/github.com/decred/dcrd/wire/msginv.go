...
// MsgInv implements the Message interface and represents a Eacred inv message.
...
// NewMsgInv returns a new Eacred inv message that conforms to the Message
...
// NewMsgInvSizeHint returns a new Eacred inv message that conforms to the

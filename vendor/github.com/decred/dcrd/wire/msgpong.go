...
// MsgPong implements the Message interface and represents a Eacred pong
// message which is used primarily to confirm that a connection is still valid
// in response to a Eacred ping message (MsgPing).
//
...
// NewMsgPong returns a new Eacred pong message that conforms to the Message

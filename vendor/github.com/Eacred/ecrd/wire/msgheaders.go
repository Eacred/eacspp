...
// a single Eacred headers message.
const MaxBlockHeadersPerMsg = 2000

// MsgHeaders implements the Message interface and represents a Eacred headers
...
// NewMsgHeaders returns a new Eacred headers message that conforms to the

...
// MsgMemPool implements the Message interface and represents a Eacred mempool
...
// NewMsgMemPool returns a new Eacred pong message that conforms to the Message

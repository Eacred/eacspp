...
// maxNetAddressPayload returns the max payload size for a Eacred NetAddress
...
type NetAddress struct {
	...
	// not present in the Eacred version message (MsgVersion) nor was it
...
func readNetAddress(r io.Reader, pver uint32, na *NetAddress, ts bool) error {
	...
	// NOTE: The Eacred protocol uses a uint32 for the timestamp so it will
	...
	// Sigh.  Eacred protocol mixes little and big endian.

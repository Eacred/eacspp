...
// MsgReject implements the Message interface and represents a Eacred reject
// message.
//
...
func (msg *MsgReject) MaxPayloadLength(pver uint32) uint32 {
	// Unfortunately the Eacred protocol does not enforce a sane
...
// NewMsgReject returns a new Eacred reject message that conforms to the
